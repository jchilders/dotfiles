...
nnoremap <silent> <Leader>W <cmd>wqa<CR>
...
nnoremap <silent> <leader>gc <cmd>lua print(vim.inspect(vim.lsp.buf_get_clients()))<CR>

" Change (rename) symbol under cursor ('change current symbol')
nnoremap <silent> <Leader>ccs <cmd>lua vim.lsp.buf.rename()<cr>
